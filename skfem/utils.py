...
from .assembly import asm, BilinearForm, LinearForm, DofsView
from .assembly.basis import AbstractBasis
from .element import ElementVector
Solution = Union[ndarray, Tuple[ndarray, ndarray]]
LinearSolver = Callable[..., ndarray]
EigenSolver = Callable[..., Tuple[ndarray, ndarray]]
LinearSystem = Union[spmatrix, Tuple[spmatrix, ndarray], Tuple[spmatrix, spmatrix]]
CondensedSystem = Union[LinearSystem, Tuple[spmatrix, ndarray, ndarray], Tuple[spmatrix, ndarray, ndarray, ndarray], Tuple[spmatrix, spmatrix, ndarray, ndarray]]
DofsCollection = Union[ndarray, DofsView, Dict[str, DofsView]]

def build_pc_ilu(A: spmatrix, drop_tol: Optional[float]=0.0001, fill_factor: Optional[float]=20) -> spl.LinearOperator:
...
def solver_eigen_scipy_sym(**kwargs) -> EigenSolver:
    ...
    """
    params = {'sigma': 10, 'k': 5, 'mode': 'normal'}
    params.update(kwargs)
...
def solver_iter_krylov(krylov: Optional[LinearSolver]=spl.cg, verbose: Optional[bool]=False, **kwargs) -> LinearSolver:
    ...
    def solver(A, b, **solve_time_kwargs):
        ...
        if info > 0:
            ...
            print(f'{krylov.__name__} converged to ' + f"tol={kwargs.get('tol', 'default')} and " + f"atol={kwargs.get('atol', 'default')}")
        return sol
    return solver
...
def solve_eigen(A: spmatrix, M: spmatrix, x: Optional[ndarray]=None, I: Optional[ndarray]=None, solver: Optional[Union[EigenSolver]]=None, **kwargs) -> Tuple[ndarray, ndarray]:
    if solver is None:
...
def solve_linear(A: spmatrix, b: ndarray, x: Optional[ndarray]=None, I: Optional[ndarray]=None, solver: Optional[Union[LinearSolver]]=None, **kwargs) -> ndarray:
    if solver is None:
...
def solve(A: spmatrix, b: Union[ndarray, spmatrix], x: Optional[ndarray]=None, I: Optional[ndarray]=None, solver: Optional[Union[LinearSolver, EigenSolver]]=None, **kwargs) -> Solution:
...
def _flatten_dofs(S: Optional[DofsCollection]) -> Optional[ndarray]:
    ...
    if isinstance(S, ndarray):
        ...
        return np.unique(np.concatenate([_flatten_helper(S, key) for key in S]))
    raise NotImplementedError('Unable to flatten the given set of DOFs.')

def _init_bc(A: spmatrix, b: Optional[Union[ndarray, spmatrix]]=None, x: Optional[ndarray]=None, I: Optional[DofsCollection]=None, D: Optional[DofsCollection]=None) -> Tuple[Optional[ndarray], ndarray, ndarray, ndarray]:
    D = _flatten_dofs(D)
    I = _flatten_dofs(I)
...
def enforce(A: spmatrix, b: Optional[Union[ndarray, spmatrix]]=None, x: Optional[ndarray]=None, I: Optional[DofsCollection]=None, D: Optional[DofsCollection]=None, diag: float=1.0, overwrite: bool=False) -> LinearSystem:
    ...
    if b is not None:
        if isinstance(b, spmatrix):
            bout = enforce(b, D=D, diag=0.0, overwrite=overwrite)
        else:
...
def penalize(A: spmatrix, b: Optional[Union[ndarray, spmatrix]]=None, x: Optional[ndarray]=None, I: Optional[DofsCollection]=None, D: Optional[DofsCollection]=None, epsilon: Optional[float]=None, overwrite: bool=False) -> LinearSystem:
...
def condense(A: spmatrix, b: Optional[Union[ndarray, spmatrix]]=None, x: Optional[ndarray]=None, I: Optional[DofsCollection]=None, D: Optional[DofsCollection]=None, expand: bool=True) -> CondensedSystem:
...
def projection(fun, basis_to: Optional[AbstractBasis]=None, basis_from: Optional[AbstractBasis]=None, diff: Optional[int]=None, I: Optional[ndarray]=None, expand: bool=False) -> ndarray:
...
def project(fun, basis_from: Optional[AbstractBasis]=None, basis_to: Optional[AbstractBasis]=None, diff: Optional[int]=None, I: Optional[ndarray]=None, expand: bool=False) -> ndarray:
    warnings.warn('project is deprecated in favor of projection.', DeprecationWarning)
    return projection(fun, basis_to=basis_to, basis_from=basis_from, diff=diff, I=I, expand=expand)